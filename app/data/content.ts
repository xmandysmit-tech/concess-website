...
export const studioCases: StudioCase[] = [
    ...
    extraSections: [
      {
        ...
        photos: [
          "/images/studio/YouTune/YouTune-filter.png",
    ...
    extraSections: [
      {
        ...
        photos: [
          "/images/studio/Grote jongens/Grote-jongens-filters.png",
  ...
  {
  {
    ...
    year: "2022",
    heroIsTrailer: true,
    cover: "/images/studio/Tante Soof/Tante-Soof-thumbnail-concess.jpg",
    hoverVideo: "https://www.youtube.com/watch?v=xeBcuwT0TfU",
    gradient: "from-pink-900 to-neutral-950",
    tagline: "Concess Studio",
    description: "In Tante Soof geeft Sophie Milzink samen met bekende gasten advies op problemen van haar kijkers. Na een succesvol seizoen van 14 afleveringen hebben we in samenwerking met Videoland 4 speciale Tante Soof x Temptation Island afleveringen mogen maken waarin Sophie samen met de deelnemers en verleiders van Temptation Island vragen van haar kijkers ging beantwoorden.",
    platformLink: "https://www.youtube.com/watch?v=xeBcuwT0TfU",
    platformLinkLabel: "Bekijk video",
    gallery: [],
  },
  {
    slug: "iconic-by-dyson",
    title: "Iconic by Dyson",
    subtitle: "LINDA.NL × Talpa",
    tags: ["Productie", "Social Content"],
    year: "2022",
    heroIsTrailer: true,
    cover: "/images/studio/Dyson x Linda/Linda-Dyson-thumbnail-concess.jpg",
    hoverVideo: "https://www.youtube.com/watch?v=T4iG1i6fxwk",
    gradient: "from-fuchsia-900 to-neutral-950",
    tagline: "Concess Studio",
    description: "In opdracht van LINDA.NL/Talpa heeft Concess de productie, het projectmanagement en het scouten van modellen voor een Instagram reels video in samenwerking met Dyson mogen verzorgen. In deze video is te zien hoe verschillende modellen omgetoverd worden tot Beyoncé, Brigitte Bardot en Diana Ross met de verschillende Dyson opzetstukken.",
    platformLink: "https://www.youtube.com/watch?v=T4iG1i6fxwk",
    platformLinkLabel: "Bekijk video",
    gallery: [],
  },
  {
    slug: "dutch-performante-emma-sleep",
    title: "Dutch Performante x Emma Sleep",
    tags: ["Productie"],
    year: "2022",
    heroIsTrailer: true,
    cover: "/images/studio/Dutch Performante x Emma Sleep/Dutch-Performante-Emma-Sleep-thumbnail.jpg",
    hoverVideo: "https://www.youtube.com/watch?v=jG7_ODKm3qc",
    gradient: "from-violet-900 to-neutral-950",
    tagline: "Concess Studio",
    description: "In samenwerking met Emma Sleep heeft Dutch Performante een video mogen maken voor zijn YouTube kanaal waar hij een Emma Sleep Boxspring mag weggeven aan diegene die het langst wakker kan blijven. Om de challenge lastiger te maken, krijgen ze opdrachten tussendoor zoals massages, slaapthee drinken en een noise canceling koptelefoon op. 4 influencers strijden voor het bed.",
    platformLink: "https://www.youtube.com/watch?v=jG7_ODKm3qc",
    platformLinkLabel: "Bekijk video",
    gallery: [],
  },
  {
    slug: "dutch-performante-vpcars-bmw",
    title: "Dutch Performante x VP Cars",
    subtitle: "Wie houdt zijn hand het langst op de BMW?",
    tags: ["Productie"],
    year: "2022",
    heroIsTrailer: true,
    cover: "/images/studio/Dutch Performante x VPCars/Dutch-Performante-Van-Poelgeest-thumbnail.jpg",
    hoverVideo: "https://www.youtube.com/watch?v=eTqH_TODaVw",
    gradient: "from-blue-900 to-neutral-950",
    tagline: "Concess Studio",
    description: "In samenwerking met Van Poelgeest Naarden (VP Cars) heeft Dutch Performante een video mogen maken voor zijn YouTube kanaal waar hij een BMW I3 mag weggeven aan diegene die zijn of haar hand het langste op de auto heeft gehouden. Om de challenge lastiger te maken krijgen ze opdrachten tussendoor zoals een gewicht boven het hoofd houden of op 1 been staan. 4 influencers strijden voor de auto.",
    platformLink: "https://www.youtube.com/watch?v=eTqH_TODaVw",
    platformLinkLabel: "Bekijk video",
    gallery: [],
  },
  {
    slug: "tantoe-muzikaal",
    ...
    extraSections: [
      {
        ...
        photos: ["/images/studio/Tantoe Muzikaal/Tantoe-Muzikaal-Filter.png"],
        large: true,
      },
    ],
    gallery: [],
  ...
  {
    slug: "milan-knol-focus-drink",
    title: "Milan Knol x Focus Drink",
    tags: ["Productie"],
    year: "2022",
    heroIsTrailer: true,
    cover: "/images/studio/Milan Knol x Focus Drink/focus-drink-milan-knol-thumbnail-concess.jpg",
    hoverVideo: "https://www.youtube.com/watch?v=3jjV_51MpFk",
    gradient: "from-cyan-900 to-neutral-950",
    tagline: "Concess Studio",
    description: "Voor de samenwerking tussen Milan Knol en Focus Drink hebben wij een dedicated YouTube video mogen produceren. In deze video hebben wij door middel van verborgen camera's, fans van Focus Drink verrast en een kans gegeven om aan het 'Rad van Focus' te draaien. Hiermee hebben de fans een extra Focus Drink prijs gewonnen zoals gratis flesjes Focus Drink, Focus Drink merchandise of een ritje in de Lamborghini van ambassadeur Dutch Performante.\n\nMet dank aan Jumbo Heemskerk en Albert Heijn Purmerend.",
    platformLink: "https://www.youtube.com/watch?v=3jjV_51MpFk",
    platformLinkLabel: "Bekijk video",
    gallery: [],
  },
  {
    slug: "open-kaart",
    title: "Open Kaart",
    subtitle: "Robbert Rodenburg",
    tags: ["Productie", "AR Filters"],
    year: "2022",
    cover: "/images/studio/Open Kaart - Robbert Rodenburg/Open-Kaart-thumbnail-concess.jpg",
    hoverVideo: "https://www.youtube.com/robbertrodenburg",
    gradient: "from-indigo-900 to-neutral-950",
    tagline: "Concess Studio",
    description: "In Open Kaart heeft Robbert Rodenburg een diepte interview met zijn gasten door middel van kaartjes waar vragen op staan voor elkaar. Concess heeft de productie van het 4e en 5e seizoen mogen verzorgen. Hier waren o.a. Romee Strijd, Hans Klok, Kees van der Spek, Mikky Kiemeney, Patty Brard, Tabitha, Thomas van der Vlugt en Sylvie Meis te gast.",
    platformLink: "https://www.youtube.com/robbertrodenburg",
    platformLinkLabel: "YouTube kanaal",
    extraSections: [
      {
        label: "AR Filter",
        title: "Open Kaart Filter",
        text: "Met het 'Open Kaart' AR Filter kan je zelf de vragen uit het format beantwoorden.",
        photos: ["/images/studio/Open Kaart - Robbert Rodenburg/Open-Kaart-filter.png"],
        large: true,
      },
    ],
    gallery: [],
  ...
  {
    slug: "bram-in-controle",
    title: "Bram in Controle",
    tags: ["Productie"],
    year: "2022",
    cover: "/images/studio/Bram in controle/Bram-in-controle-thumbnail-concess.jpg",
    gradient: "from-red-900 to-neutral-950",
    tagline: "Concess Studio",
  ...
  {
    slug: "milan-knol-world-of-warships",
    title: "Milan Knol x World of Warships",
    tags: ["Productie"],
    year: "2022",
    cover: "/images/studio/Milan Knol x World of Warships/world-of-warships-milan-knol-thumbnail-concess.jpg",
