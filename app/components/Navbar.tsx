...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        {/* Always cover the iOS safe area (notch/status bar) with cream, even when navbar is transparent */}
        <div style={{ height: "env(safe-area-inset-top)", background: "var(--color-linen-100)" }} />
      ...
      {/* Mobile menu overlay */}
      {menuOpen && (
        <div className="fixed inset-0 z-50 flex flex-col" style={{ background: "#faf8f5", paddingTop: "env(safe-area-inset-top)" }}>
          {/* Logo row */}
