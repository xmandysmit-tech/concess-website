      ...
      {(youtubeId && project.instagramEmbed) && (
        <section className="pb-12 max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:items-start">
            {/* YouTube — full width op mobile, flex-1 op desktop */}
            <div className="w-full md:flex-1 rounded-2xl overflow-hidden" style={{ aspectRatio: "16/9", background: "var(--color-dark-900)" }}>
              <iframe
            ...
            {/* Instagram — portrait formaat */}
            <div className="rounded-2xl overflow-hidden mx-auto md:mx-0 md:flex-shrink-0" style={{ width: 280, aspectRatio: "9/16", background: "var(--color-dark-900)" }}>
              <iframe
